...
export default defineComponent({
  ...
  setup(props: TdTagInputProps, context) {
    ...
    const {
      tagValue, onClose, onInnerEnter, onInputBackspaceKeyUp, clearAll,
    } = useTagList(props, context);
    ...
    const tagInputPlaceholder = computed(() => (isHoverRef.value || !tagValue.value?.length ? props.placeholder : ''));

    const showClearIcon = computed(() => Boolean(!props.readonly && !props.disabled && props.clearable && isHoverRef.value && tagValue.value?.length));
