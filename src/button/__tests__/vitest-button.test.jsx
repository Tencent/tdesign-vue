 ...
 * This file generated by scripts of tdesign-api. `npm run api:docs Button Vue(PC) vitest,finalProject`
...
describe('Button Component', () => {
  it('props.block works fine', () => {
    ...
    const wrapper3 = mount({
      render() {
        return <Button block={false}>Text</Button>;
      },
    });
  ...
  it('props.content works fine', () => {
    const wrapper = mount({
      render() {
        return <Button content={(h) => <span class="custom-node">TNode</span>}></Button>;
      },
    });
  ...
  it('slots.content works fine', () => {
    const wrapper = mount({
      render() {
        return <Button scopedSlots={{ content: (h) => <span class="custom-node">TNode</span> }}></Button>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.element).toMatchSnapshot();
  ...
  it('props.default works fine', () => {
    const wrapper = mount({
      render() {
        return <Button default={(h) => <span class="custom-node">TNode</span>}></Button>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.element).toMatchSnapshot();
  ...
  it('slots.default works fine', () => {
    const wrapper = mount({
      render() {
        return <Button scopedSlots={{ default: (h) => <span class="custom-node">TNode</span> }}></Button>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.element).toMatchSnapshot();
  ...
  it('props.disabled works fine', () => {
    ...
    const wrapper3 = mount({
      render() {
        return <Button disabled={false}>Text</Button>;
      },
    });
  ...
  it('props.ghost works fine', () => {
    ...
    const wrapper2 = mount({
      render() {
        return <Button ghost={true}>Text</Button>;
      },
    });
    ...
    const wrapper3 = mount({
      render() {
        return <Button ghost={false}>Text</Button>;
      },
    });
  ...
  it('props.icon works fine', () => {
    const wrapper = mount({
      render() {
        return <Button icon={(h) => <span class="custom-node">TNode</span>}>Text</Button>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
  });
  ...
  it('slots.icon works fine', () => {
    const wrapper = mount({
      render() {
        return <Button scopedSlots={{ icon: (h) => <span class="custom-node">TNode</span> }}>Text</Button>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
  });
  ...
  it('props.loading works fine', () => {
    ...
    const wrapper3 = mount({
      render() {
        return <Button loading={false}>Text</Button>;
      },
    });
  ...
  ['rectangle', 'square', 'round', 'circle'].forEach((item, index) => {
    it(`props.shape is equal to ${item}`, () => {
      const wrapper = mount({
        render() {
          return <Button shape={item}>Text</Button>;
        },
      });
  ...
  ['small', 'medium', 'large'].forEach((item, index) => {
    it(`props.size is equal to ${item}`, () => {
      const wrapper = mount({
        render() {
          return <Button size={item}>Text</Button>;
        },
      });
  ...
  it('props.suffix works fine', () => {
    const wrapper = mount({
      render() {
        return <Button suffix={(h) => <span class="custom-node">TNode</span>}>Text</Button>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
  });
  ...
  ['button', 'a', 'div'].forEach((item, index) => {
    it(`props.tag is equal to ${item}`, () => {
      const wrapper = mount({
        render() {
          return <Button tag={item}>Text</Button>;
        },
      });
  ...
  ['default', 'primary', 'danger', 'warning', 'success'].forEach((item) => {
    it(`props.theme is equal to ${item}`, () => {
      const wrapper = mount({
        render() {
          return <Button theme={item}>Text</Button>;
        },
      });
  ...
  ['submit', 'reset', 'button'].forEach((item, index) => {
    it(`props.type is equal to ${item}`, () => {
      const wrapper = mount({
        render() {
          return <Button type={item}></Button>;
        },
      });
  ...
  ['base', 'outline', 'dashed', 'text'].forEach((item) => {
    it(`props.variant is equal to ${item}`, () => {
      const wrapper = mount({
        render() {
          return <Button variant={item}>Text</Button>;
        },
      });
  ...
  it('Button Event: click', async () => {
    ...
    const wrapper = mount({
      render() {
        return <Button on={{ click: fn }}></Button>;
      },
    });
