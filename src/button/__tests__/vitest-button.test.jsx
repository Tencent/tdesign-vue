...
describe('Button Component', () => {
  ...
  it('slots.content works fine', () => {
    const wrapper = mount({
      render() {
        return <Button scopedSlots={{ content: () => <span class="custom-node">TNode</span> }}></Button>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.element).toMatchSnapshot();
  ...
  it('slots.default works fine', () => {
    const wrapper = mount({
      render() {
        return <Button scopedSlots={{ default: () => <span class="custom-node">TNode</span> }}></Button>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.element).toMatchSnapshot();
  ...
  it('slots.icon works fine', () => {
    const wrapper = mount({
      render() {
        return <Button scopedSlots={{ icon: () => <span class="custom-node">TNode</span> }}>Text</Button>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
  });
