...
onRemove | Function |  | Typescript：`(options: RemoveOptions<DataOption>) => void`<br/>[see more ts definition](https://github.com/Tencent/tdesign-vue/tree/develop/src/tree-select/type.ts)。<br/>`interface RemoveOptions<T> { value: string \| number \| {[key: string]: any}; data: T; index: number; e?: MouseEvent \| KeyboardEvent; trigger: 'tag-remove' \| 'backspace' }`<br/> | N
...
remove | `(options: RemoveOptions<DataOption>)` | [see more ts definition](https://github.com/Tencent/tdesign-vue/tree/develop/src/tree-select/type.ts)。<br/>`interface RemoveOptions<T> { value: string \| number \| {[key: string]: any}; data: T; index: number; e?: MouseEvent \| KeyboardEvent; trigger: 'tag-remove' \| 'backspace' }`<br/>
