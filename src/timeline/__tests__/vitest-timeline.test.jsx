 ...
 * This file generated by scripts of tdesign-api. `npm run api:docs Timeline Vue(PC) vitest,finalProject`
...
describe('Timeline Component', () => {
  ...
  ['alternate', 'same'].forEach((item) => {
    it(`props.mode is equal to ${item}`, () => {
      const wrapper = mount({
        render() {
          return <Timeline mode={item}></Timeline>;
        },
      });
...
describe('TimelineItem Component', () => {
  it('props.content works fine', () => {
    const wrapper = mount({
      render() {
        return <TimelineItem content={(h) => <span class="custom-node">TNode</span>}></TimelineItem>;
      },
    });
  ...
  it('slots.content works fine', () => {
    const wrapper = mount({
      render() {
        return <TimelineItem scopedSlots={{ content: (h) => <span class="custom-node">TNode</span> }}></TimelineItem>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.element).toMatchSnapshot();
  ...
  it('props.dot works fine', () => {
    const wrapper = mount({
      render() {
        return <TimelineItem dot={(h) => <span class="custom-node">TNode</span>}></TimelineItem>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
  });
  ...
  it('slots.dot works fine', () => {
    const wrapper = mount({
      render() {
        return <TimelineItem scopedSlots={{ dot: (h) => <span class="custom-node">TNode</span> }}></TimelineItem>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
  });
  ...
  Object.entries(dotColorClassNameMap).forEach(([enumValue, expectedClassName]) => {
    it(`props.dotColor is equal to ${enumValue}`, () => {
      ...
      const wrapper = mount({
        render() {
          return <TimelineItem dotColor={propValue}></TimelineItem>;
        },
      }).find('.t-timeline-item__dot');
      expect(wrapper.classes(expectedClassName)).toBeTruthy();
    });
  });
  ...
  it('props.dotColor is equal to yellowgreen', () => {
    const wrapper = mount({
      render() {
        return <TimelineItem dotColor={'yellowgreen'}></TimelineItem>;
      },
    });
  ...
  it('props.label works fine', () => {
    const wrapper = mount({
      render() {
        return <TimelineItem label={(h) => <span class="custom-node">TNode</span>}></TimelineItem>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.element).toMatchSnapshot();
  ...
  it('slots.label works fine', () => {
    const wrapper = mount({
      render() {
        return <TimelineItem scopedSlots={{ label: (h) => <span class="custom-node">TNode</span> }}></TimelineItem>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.element).toMatchSnapshot();
  ...
  it('props.loading: TimelineItem contains element `.t-timeline-item__dot .t-loading`', () => {
    ...
    const wrapper1 = mount({
      render() {
        return <TimelineItem loading={false}></TimelineItem>;
      },
    });
    ...
    const wrapper2 = mount({
      render() {
        return <TimelineItem loading={true}></TimelineItem>;
      },
    });
