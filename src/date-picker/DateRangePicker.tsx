...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    function onYearChange(nextVal: number, { partial }: { partial: DateRangePickerPartial }) {
      const { nextYear, nextMonth, onlyYearSelect } = onDateRangePickerYearChangeSharedFn(nextVal, {
        partial,
        enableTimePicker: props.enableTimePicker,
        activeIndex,
        mode: props.mode,
    ...
    function onMonthChange(nextVal: number, { partial }: { partial: DateRangePickerPartial }) {
      const { nextYear, nextMonth } = onDateRangePickerMonthChangeSharedFn(nextVal, {
        partial,
        enableTimePicker: props.enableTimePicker,
        activeIndex,
        mode: props.mode,
