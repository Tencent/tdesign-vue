 ...
 * This file generated by scripts of tdesign-api. `npm run api:docs Guide Vue(PC) vitest,finalProject`
...
describe('Guide Component', () => {
  ...
  it('props.counter works fine', async () => {
    getGuideDefaultMount(Guide, { counter: (h) => <span class="custom-node">TNode</span> });
    await mockDelay(60);
  ...
  it('slots.counter works fine', async () => {
    getGuideDefaultMount(Guide, { scopedSlots: { counter: (h) => <span class="custom-node">TNode</span> } });
    await mockDelay(60);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
    const tGuideCounterDom = document.querySelector('.t-guide__counter');
  ...
  it('slots.counter: a function with params', async () => {
    const fn = vi.fn();
    getGuideDefaultMount(Guide, { scopedSlots: { counter: fn } });
    await mockDelay(60);
    expect(fn).toHaveBeenCalled();
  ...
  it('props.highlightPadding is equal to 32', async () => {
    ...
    await mockDelay(60);
    const domWrapper = document.querySelector('.t-guide__highlight--popup');
  ...
  it('events.change works fine', async () => {
    ...
    const wrapper = getGuideMultipleStepsMount(Guide, { current: 0 }, { change: onChangeFn });
    await mockDelay(60);
  ...
  it('events.change works fine', async () => {
    const onChangeFn = vi.fn();
    const wrapper = getGuideMultipleStepsMount(Guide, { current: 1 }, { change: onChangeFn });
    await mockDelay(60);
  ...
  it('events.finish works fine', async () => {
    ...
    const wrapper = getGuideMultipleStepsMount(Guide, { current: 2 }, { finish: onFinishFn });
    await mockDelay(60);
  ...
  it('events.nextStepClick works fine', async () => {
    ...
    const wrapper = getGuideMultipleStepsMount(Guide, { current: 1 }, { 'next-step-click': onNextStepClickFn });
    await mockDelay(60);
    document.querySelector('.t-guide__next').click();
    await wrapper.vm.$nextTick();
  ...
  it('events.prevStepClick works fine', async () => {
    ...
    const wrapper = getGuideMultipleStepsMount(Guide, { current: 1 }, { 'prev-step-click': onPrevStepClickFn });
    await mockDelay(60);
    document.querySelector('.t-guide__prev').click();
    await wrapper.vm.$nextTick();
  ...
  it('events.skip works fine', async () => {
    ...
    const wrapper = getGuideMultipleStepsMount(Guide, { current: 0 }, { skip: onSkipFn });
    await mockDelay(60);
...
describe('Guide Component', () => {
  ...
  it('GuideStep.body works fine', async () => {
    getCustomGuideStepMount(Guide, { body: (h) => <span class="custom-node">TNode</span> });
    await mockDelay(60);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
  ...
  it('slots.body works fine', async () => {
    getCustomGuideStepMount(Guide, { scopedSlots: { body: (h) => <span class="custom-node">TNode</span> } });
    await mockDelay(60);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
    expect(document.body).toMatchSnapshot();
  ...
  it('GuideStep.content works fine', async () => {
    getCustomGuideStepMount(Guide, { content: (h) => <span class="custom-node">TNode</span> });
    await mockDelay(60);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
    expect(document.body).toMatchSnapshot();
  ...
  it('slots.content works fine', async () => {
    getCustomGuideStepMount(Guide, { scopedSlots: { content: (h) => <span class="custom-node">TNode</span> } });
    await mockDelay(60);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
    expect(document.body).toMatchSnapshot();
  ...
  it('GuideStep.highlightContent works fine', async () => {
    getCustomGuideStepMount(Guide, { highlightContent: (h) => <span class="custom-node">TNode</span> });
    await mockDelay(60);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
    expect(document.body).toMatchSnapshot();
  ...
  it('slots.highlightContent works fine', async () => {
    getCustomGuideStepMount(Guide, {
      scopedSlots: { highlightContent: (h) => <span class="custom-node">TNode</span> },
    });
    await mockDelay(60);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
  ...
  it('slots.highlight-content works fine', async () => {
    getCustomGuideStepMount(Guide, {
      scopedSlots: { 'highlight-content': (h) => <span class="custom-node">TNode</span> },
    });
    await mockDelay(60);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
  ...
  it('GuideStep.title works fine', async () => {
    getCustomGuideStepMount(Guide, { title: (h) => <span class="custom-node">TNode</span> });
    await mockDelay(60);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
    expect(document.body).toMatchSnapshot();
  ...
  it('slots.title works fine', async () => {
    getCustomGuideStepMount(Guide, { scopedSlots: { title: (h) => <span class="custom-node">TNode</span> } });
    await mockDelay(60);
    const customNodeDom = document.querySelector('.custom-node');
    expect(customNodeDom).toBeTruthy();
    expect(document.body).toMatchSnapshot();
