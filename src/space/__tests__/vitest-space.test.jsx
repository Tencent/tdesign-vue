 ...
 * This file generated by scripts of tdesign-api. `npm run api:docs Space Vue(PC) vitest,finalProject`
...
describe('Space Component', () => {
  ...
  it('props.breakLine is equal to true', () => {
    ...
    expect(domWrapper.element.classList.contains('t-space--break-line')).toBeTruthy();
  });
  ...
  it('props.separator works fine', () => {
    const wrapper = getSpaceDefaultMount(Space, { separator: (h) => <span class="custom-node">TNode</span> });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
  });

  it('slots.separator works fine', () => {
    const wrapper = getSpaceDefaultMount(Space, {
      scopedSlots: { separator: (h) => <span class="custom-node">TNode</span> },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
  });
