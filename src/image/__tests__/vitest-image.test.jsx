 ...
 * This file generated by scripts of tdesign-api. `npm run api:docs Image Vue(PC) vitest,finalProject`
...
describe('Image Component', () => {
  ...
  it('props.gallery works fine', () => {
    ...
    const wrapper2 = mount({
      render() {
        return <Image gallery={true}></Image>;
      },
    });
    ...
    const wrapper3 = mount({
      render() {
        return <Image gallery={false}></Image>;
      },
    });
  ...
  it('props.loading works fine', () => {
    const wrapper = mount({
      render() {
        return <Image loading={(h) => <span class="custom-node">TNode</span>}></Image>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.element).toMatchSnapshot();
  ...
  it('slots.loading works fine', () => {
    const wrapper = mount({
      render() {
        return <Image scopedSlots={{ loading: (h) => <span class="custom-node">TNode</span> }}></Image>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.element).toMatchSnapshot();
  ...
  it('props.overlayContent works fine', () => {
    const wrapper = mount({
      render() {
        return <Image overlayContent={(h) => <span class="custom-node">TNode</span>}></Image>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
  ...
  it('slots.overlayContent works fine', () => {
    const wrapper = mount({
      render() {
        return <Image scopedSlots={{ overlayContent: (h) => <span class="custom-node">TNode</span> }}></Image>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.find('.t-image__overlay-content').exists()).toBeTruthy();
  ...
  it('props.placeholder works fine', () => {
    const wrapper = mount({
      render() {
        return <Image placeholder={(h) => <span class="custom-node">TNode</span>}></Image>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.element).toMatchSnapshot();
  ...
  it('slots.placeholder works fine', () => {
    const wrapper = mount({
      render() {
        return <Image scopedSlots={{ placeholder: (h) => <span class="custom-node">TNode</span> }}></Image>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
    expect(wrapper.element).toMatchSnapshot();
  ...
  Object.entries(positionClassNameMap).forEach(([enumValue, expectedClassName]) => {
    it(`props.position is equal to ${enumValue}`, () => {
      ...
      const wrapper = mount({
        render() {
          return <Image position={propValue}></Image>;
        },
      }).find('.t-image');
  ...
  ['circle', 'round', 'square'].forEach((item) => {
    it(`props.shape is equal to ${item}`, () => {
      const wrapper = mount({
        render() {
          return <Image shape={item}></Image>;
        },
      }).find('.t-image__wrapper');
