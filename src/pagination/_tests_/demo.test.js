...
import customizableVue from '@/examples/pagination/demos/customizable.vue';
import disabledVue from '@/examples/pagination/demos/disabled.vue';
import fewVue from '@/examples/pagination/demos/few.vue';
