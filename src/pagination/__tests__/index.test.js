...
describe('Pagination', () => {
    ...
    it(':current__model', async () => {
      const wrapper = mount({
        ...
        render() {
          return (
            <Pagination
              total={defaultPaginationProps.total}
  ...
  describe('@event', () => {
    it('@change', async () => {
      ...
      await wrapper.find('.t-pagination__number--more').trigger('click');
      expect(onChange).toHaveBeenCalledTimes(5);
      await wrapper.find('.t-pagination__number--more:nth-child(2)').trigger('click');
    ...
    it('@page-size-change', async () => {
      ...
      wrapper.vm.onSelectorChange('50');
    ...
    it(':totalContent', async () => {
      const wrapper = mount({
        render() {
          return (
            <Pagination>
              <div slot="totalContent" data-testid="total-content">
                TOTAL
              </div>
            </Pagination>
          );
