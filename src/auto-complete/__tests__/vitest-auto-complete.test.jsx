...
import { mockDelay, createElementById, simulateKeydownEvent } from '@test/utils';
...
describe('AutoComplete Component', () => {
  it('props.autofocus is equal to false', () => {
    const wrapper = mount({
      render() {
        return <AutoComplete autofocus={false}></AutoComplete>;
      },
    });
  ...
  it('props.autofocus is equal to true', () => {
    const wrapper = mount({
      render() {
        return <AutoComplete autofocus={true}></AutoComplete>;
      },
    });
    const domWrapper = wrapper.find('input');
  ...
  it('props.clearable: expect trigger clear and change events after clear icon has been clicked', async () => {
    ...
    const wrapper = getNormalAutoCompleteMount(
      ...
      { clear: onClearFn1, change: onChangeFn1 },
    );
    wrapper.find('.t-input').trigger('mouseenter');
    await wrapper.vm.$nextTick();
    expect(wrapper.find('.t-input__suffix-clear').exists()).toBeTruthy();
  ...
  it('props.default works fine', () => {
    const wrapper = mount({
      render() {
        return <AutoComplete default={(h) => <span class="custom-node">TNode</span>}></AutoComplete>;
      },
    });
  ...
  it('props.disabled works fine', () => {
    ...
    const wrapper2 = mount({
      render() {
        return <AutoComplete disabled={true}></AutoComplete>;
      },
    }).find('.t-input');
    ...
    const wrapper3 = mount({
      render() {
        return <AutoComplete disabled={false}></AutoComplete>;
      },
    }).find('.t-input');
  ...
  it('props.panelBottomContent works fine', async () => {
    ...
    const wrapper = mount(
      {
        render() {
          return <AutoComplete panelBottomContent={(h) => <span class="custom-node">TNode</span>}></AutoComplete>;
        },
      },
      { attachTo: '#focus-dom' },
    );
    ...
    const wrapper = mount(
      {
        render() {
          return (
            <AutoComplete
              scopedSlots={{ 'panel-bottom-content': (h) => <span class="custom-node">TNode</span> }}
            ></AutoComplete>
          );
        },
      },
  ...
  it('props.panelTopContent works fine', async () => {
    ...
    const wrapper = mount(
      {
        render() {
          return <AutoComplete panelTopContent={(h) => <span class="custom-node">TNode</span>}></AutoComplete>;
        },
      },
      { attachTo: '#focus-dom' },
    );
    ...
    const wrapper = mount(
      {
        render() {
          return (
            <AutoComplete
              scopedSlots={{ panelTopContent: (h) => <span class="custom-node">TNode</span> }}
            ></AutoComplete>
          );
        },
      },
    ...
    const wrapper = mount(
      {
        render() {
          return (
            <AutoComplete
              scopedSlots={{ 'panel-top-content': (h) => <span class="custom-node">TNode</span> }}
            ></AutoComplete>
          );
        },
      },
  ...
  it('props.triggerElement works fine', () => {
    const wrapper = mount({
      render() {
        return <AutoComplete triggerElement={(h) => <span class="custom-node">TNode</span>}></AutoComplete>;
      },
    });
    expect(wrapper.find('.custom-node').exists()).toBeTruthy();
  });
  ...
  it('slots.trigger-element works fine', () => {
    const wrapper = mount({
      render() {
        return (
          <AutoComplete
            scopedSlots={{ 'trigger-element': (h) => <span class="custom-node">TNode</span> }}
          ></AutoComplete>
        );
      },
    });
  ...
  it('events.focus works fine', async () => {
    const onFocusFn = vi.fn();
    const wrapper = getNormalAutoCompleteMount(AutoComplete, {}, { focus: onFocusFn });
    wrapper.find('input').trigger('focus');
    await wrapper.vm.$nextTick();
  ...
  it('events.select works fine', async () => {
    ...
    await wrapper.vm.$nextTick();
    document.querySelectorAll('.t-select-option').forEach((node) => node.remove());
    expect(onSelectFn1).toHaveBeenCalled();
  ...
  it('events.select: keyboard operations: ArrowDown & ArrowUp & Enter', async () => {
    ...
    await wrapper.vm.$nextTick();
    document.querySelectorAll('.t-select-option').forEach((node) => node.remove());
    expect(onSelectFn6).toHaveBeenCalled();
