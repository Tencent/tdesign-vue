...
export default {
  ...
  theme: {
    ...
    validator(val: TdSkeletonProps['theme']): boolean {
      return ['text', 'avatar-text', 'avatar-text-complicate', 'image-paragraph-horizontal', 'image-paragraph-vertical', 'image-paragraph-horizontal-button', 'article'].includes(val);
    },
  },
};
