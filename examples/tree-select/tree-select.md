...
value | String / Number / Object / Array | - | 选中值。支持语法糖 `v-model`。TS 类型：`TreeSelectValue`。[详细类型定义](https://github.com/Tencent/tdesign-vue/tree/develop/src/tree-select/type.ts) | N
