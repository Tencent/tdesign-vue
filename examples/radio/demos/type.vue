<template>
  <div class="tdesign-radio-button-type">
    <div>
      <h5>普通单选按钮</h5>
      <t-radio-group default-value="gz">
        <t-radio value="bj">选项一</t-radio>
        <t-radio value="sh">选项二</t-radio>
        <t-radio value="gz">选项三</t-radio>
        <t-radio value="sz">选项四</t-radio>
      </t-radio-group>
    </div>
    <div>
      <h5>边框型单选按钮</h5>
