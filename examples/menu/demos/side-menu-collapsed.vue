<template>
  <t-menu theme="light" active="2-1" :collapsed="collapsed" height="550px">
    ...
    <t-menu-item value="item3"><t-icon slot="icon" name="user" />菜单内容二</t-menu-item>
    <t-menu-item value="item4" :disabled="true"><t-icon slot="icon" name="user" />菜单内容三</t-menu-item>
    <div slot="options">
