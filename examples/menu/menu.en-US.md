...
onChange | Function |  | TS 类型：`(value: MenuValue) => void`<br/> | N
onExpand | Function |  | TS 类型：`(value: Array<MenuValue>) => void`<br/> | N
...
value | String / Number | - | Typescript：`MenuValue` | N
onClick | Function |  | TS 类型：`(context: { e: MouseEvent }) => void`<br/>trigger on click | N
